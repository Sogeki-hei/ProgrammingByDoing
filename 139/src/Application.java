...
public class Application {
  public static void main(String[] args) {
    String[] males =
        {"Rob", "Darius", "Cliff", "Dane", "Monty", "Reggie", "Gus", "Vernon", "Maynard", "Gavin",
            "Ward", "Stefan", "Winfred"};

    String[] females =
        {"Laurene", "Kathy", "Yoko", "Matilda", "Georgette", "Greta", "Meg", "Ruby", "Rikki",
            "Suzanne", "Dorine", "Elaine", "Frederica"};

    String[] nouns =
        {"moment", "joy", "license", "race", "inertia", "molecule", "helicopter", "sweat", "blame",
            "brush", "art", "song", "liberty"};

    // past-tense verbs
    String[] verbs_pt =
        {"ground", "settled", "gave", "labeled", "restored", "washed", "sold", "arranged",
            "neglected", "accused", "confined"};

    String[] adjectives =
        {"overdue", "collapsed", "jealous", "topical", "naughty", "third", "sharp", "electrical",
            "bogus", "warm", "cryptic", "hopeful", "alleged"};

    String[] adverbs =
        {"endlessly", "wholly", "mentally", "brightly", "willingly", "sweetly", "legitimately",
            "behind", "instead", "within"};

    String[] colors =
        {"red", "orange", "yellow", "blue", "purple", "green", "white", "black", "pink", "brown",
            "grey", "hazel"};

    String[] numbers = {"one", "two", "three", "four", "five", "six", "seven"};

    String[] bodyparts_s =
        {"nose", "mouth", "ear", "hand", "stomach", "back", "shoulder", "hair", "spleen"};
